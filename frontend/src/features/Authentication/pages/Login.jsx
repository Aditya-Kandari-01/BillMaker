...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (res.email === "test" && password === 123){
      navigate("/home");
    }
  ...
  return (
     <main className="login-page">
      ...
      <div className="login-card">
        ...
        <div className="login-subheading">Sign in to manage your deliveries</div>

        <form onSubmit={handleSubmit}>
          <div className="login-field">
            <label htmlFor="email" className="login-label">Email address</label>
            <div className="login-input-wrap">
              <svg className="login-input-icon" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
